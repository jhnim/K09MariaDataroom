...
/////////////////////////////페이지처리 추가부분 start///////////////////////////////////////////		
		/*
		 ...
		 application 내장객체는 ServletContext를 가지고 있음
		 페이지수 계산을 위한 페이지 설정값 가져오기
		 */
		...
		String pagingImg = PagingUtil.pagingBS4(totalRecordCount, pageSize, blockPage, nowPage
